...
def check_drinks(drink_name, drink_ingredients):
    ...
    if set.intersection(set(drink_ingredients), set(ALCOHOLS)) == set():
...
def categorize_dish(dish_name, dish_ingredients):
    ...
    if set.intersection(set(dish_ingredients), VEGAN) == set(dish_ingredients):
        return dish_name + ": VEGAN"
    if set.intersection(set(dish_ingredients), VEGETARIAN) == set(dish_ingredients):
        return dish_name + ": VEGETARIAN"
    if set.intersection(set(dish_ingredients), PALEO) == set(dish_ingredients):
        return dish_name + ": PALEO"
    if set.intersection(set(dish_ingredients), KETO) == set(dish_ingredients):
        return dish_name + ": KETO"
    if set.intersection(set(dish_ingredients), OMNIVORE) == set(dish_ingredients):
