...
int say(int64_t input, char **ans){
    ...
    char * numans=malloc(40*sizeof(char));
    *ans = numans;
    char * hunans=malloc(40*sizeof(char));
    prinf("input=%lu\n",input);
...
int sayhun(int64_t input, char *hunans) {
    char * digitans=malloc(30*sizeof(char));
    char * tenans=malloc(30*sizeof(char));
    strcpy(hunans,"");
...
int sayten(int64_t input, char *tenans) {
    ...
    char * digitans=malloc(20*sizeof(char));
